...
public class BillServiceTest {
  ...
  public void testFindBetweenDates()  {
    try {
      ...
      when(billRepository.findAllByClientIdAndDateBetween(1, date1, date2))
          .thenReturn(betweenDates);
      ...
      verify(billRepository, times(1))
          .findAllByClientIdAndDateBetween(1, betweenDatesDto.getStart(), betweenDatesDto.getEnd());
